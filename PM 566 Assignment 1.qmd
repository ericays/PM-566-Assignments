...
neg |> 
  ggplot() +
  geom_bar(mapping=aes(x=pm2.5mean, y=stat(prop)))
...
neg |> 
  ggplot() +
  geom_bar(mapping=aes(x=pm2.5mean, y=stat(prop), color=Month))
...
#do I remove implausible values or keep them?? –> remove them
